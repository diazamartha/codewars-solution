...
class Kata {
    companion object {
        fun expressionsMatter(a: Int, b: Int, c: Int): Int? {
            val calculateA = a * (b + c)
            val calculateB = a * b * c
            val calculateC = a + (b * c)
            val calculateD = (a + b) * c
            val calculateE = a + b + c
            val findMax = listOf<Int>(calculateA, calculateB, calculateC, calculateD, calculateE)
